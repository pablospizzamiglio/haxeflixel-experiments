...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/map-data.csv", __ASSET__assets_data_map_data_csv);
		type.set ("assets/data/map-data.csv", AssetType.TEXT);
		className.set ("assets/images/basictiles_2.png", __ASSET__assets_images_basictiles_2_png);
		type.set ("assets/images/basictiles_2.png", AssetType.IMAGE);
		...
		var id;
		id = "assets/data/map-data.csv";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/images/basictiles_2.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_map_data_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_basictiles_2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/map-data.csv") #if display private #end class __ASSET__assets_data_map_data_csv extends lime.utils.ByteArray {}
@:image("assets/images/basictiles_2.png") #if display private #end class __ASSET__assets_images_basictiles_2_png extends lime.graphics.Image {}
@:image("assets/images/map.png") #if display private #end class __ASSET__assets_images_map_png extends lime.graphics.Image {}
@:file("D:/Applications/Haxe Toolkit/haxe/lib/flixel/3,3,11/assets/sounds/beep.mp3") #if display private #end class __ASSET__assets_sounds_beep_mp3 extends lime.utils.ByteArray {}
@:file("D:/Applications/Haxe Toolkit/haxe/lib/flixel/3,3,11/assets/sounds/flixel.mp3") #if display private #end class __ASSET__assets_sounds_flixel_mp3 extends lime.utils.ByteArray {}
@:font("D:/Applications/Haxe Toolkit/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("D:/Applications/Haxe Toolkit/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
